...
#define DIODE_FWD_VOLT_DROP_MILLIVOLTS      300                                /** Typical forward voltage drop of the diode . */
#define ADC_RES_10BIT                       1024                                /** Maximum digital value for 10-bit ADC conversion. */

#define BATT_HIG_THRESHOLD					1450								/* high threshold of battery level in which device can work (mV) */
#define BATT_LOW_THRESHOLD					1150					/* low threshold of battery level in which device can work (mV) */
