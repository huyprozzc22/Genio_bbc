...
#define BATT_HIG_THRESHOLD					2070								/* high threshold of battery level in which device can work (mV) */
#define BATT_LOW_THRESHOLD					1650					/* low threshold of battery level in which device can work (mV) */
